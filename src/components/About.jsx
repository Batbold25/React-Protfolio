...
export const About = () => {
  return (
    <about className="w-screen flex justify-center py-24 px-20 bg-gray-100">
      <div className="w-4/5 flex flex-col items-center">
        <button className=" w-20 h-7 bg-gray-200 text-slate-600 rounded flex items-center justify-center mb-12">
          About me
        </button>
        ...
        <div>
          <div className="  flex flex-row gap-12 w-full">
            ...
            <div className="w-1/2">
              <h1 className=" text-[30px] font-semibold leading-9 w-9/12">
                Curious about me? Here you have it:
              </h1>
              <div className="text-[16px] flex flex-col gap-4 w-full ">
                <p>
